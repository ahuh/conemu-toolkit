...
if "%CEL_TERM_CLIENT%"=="CONEMU" (
    ...
    wt %CEL_SPLIT_ARG% -p "%CEL_WT_WSL_PROFILE%" --title "WSL Update" --appendCommandLine bash -i -c "sudo apt update\; sudo apt upgrade -y\; sudo apt autoremove -y\; read -p 'Press Enter to exit ...'"
)
